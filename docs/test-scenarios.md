...
- Not every scenario above was promoted to a full manual test case (Part 2) or automated (Part 3) — see the manual test case document for prioritization rationale, and the automation suite for which specific scenarios were selected for automated coverage.
